...
<div class="auth-wrapper">
  <div class="auth-card">
    ...
    <form method="POST"  action="{{ route('login') }}" id="loginForm">
      ...
      <div class="mb-3">
        ...
        <div class="position-relative">
          ...
          placeholder="Enter your password" required style="padding-right:2.8rem"/>
          </div>
             @error('password')
             <div style="font-size:0.78rem;color:var(--red);margin-top:4px">
      ...
      <div class="d-flex align-items-center gap-2 mb-4">
        ...
        style="accent-color:var(--br);width:15px;height:15px;cursor:pointer" {{ old('remember') ? 'checked' : '' }} />
    ...
    <div class="text-center" style="font-size:0.88rem;color:var(--muted)">
      ...
      <a href="{{ route('register') }}" style="color:var(--br);font-weight:700;text-decoration:none">
